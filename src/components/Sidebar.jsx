...
const Sidebar = () => {
  ...
  const normalLink = 'flex items-center gap-5 pl-4 pb-2.5 rounded-lg text-gray-700  text-md m-2 dark:text-gray-200 dark:hover:text-black hover:bg-light-gray m-2'
          ...
          <div className='mt-10'>
            {links.map((item) => (
              ...
              >
                ...
                >
                  {link.icon}
                  <span className="capitalize mt-3">{link.name}</span>
                </NavLink>
                ))}
              </div>
            ))}
